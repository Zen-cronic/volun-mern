  ...
  useEffect(() => {
    if (event) {
      ...
      const shiftsWithListIds = event.shifts.map((shift) => {
        ...
        let correspondingEvent = dupEventDatesWithListIdsAndDates.find(
        ...
        if (foundCorrespondingEvent) {
          ...
          correspondingEvent = dupEventDatesWithListIdsAndDates
            .filter(
              (eventDateObj) =>
                eventDateObj.listId !== foundCorrespondingEvent.listId
            )
            .find((eventDateObj) => eventDateObj.date.includes(shiftStartDate));
        }
